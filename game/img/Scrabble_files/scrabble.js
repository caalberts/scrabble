...
exports.default = drawScrabbleBoard;
// Draw scrabble board using DOM manipulation
function drawScrabbleBoard() {
...
var _scrabbleBoard = require('./lib/scrabble-board.js');

var _scrabbleBoard2 = _interopRequireDefault(_scrabbleBoard);

var _playerRacks = require('./lib/player-racks.js');

var _playerRacks2 = _interopRequireDefault(_playerRacks);

var _scrabbleLetters = require('./lib/scrabble-letters.js');

var _scrabbleLetters2 = _interopRequireDefault(_scrabbleLetters);
...
var inventory = _scrabbleLetters2.default;

// draw Scrabble board
(0, _scrabbleBoard2.default)();
// draw Racks and Score Board then deal tiles

var players = ['player1', 'player2'];
players.forEach(function (player) {
  (0, _playerRacks2.default)(player);
  Array.from(document.querySelector('.' + player + '-rack').querySelectorAll('.empty-tile')).forEach(function (emptyTile) {
    var piece = document.createElement('div');
    piece.textContent = dealTile().letter.toUpperCase();
    piece.className = 'letter-piece';
    emptyTile.appendChild(piece);
    // emptyTile.textContent = dealTile(emptyTile).letter.toUpperCase()
    emptyTile.classList.remove('empty-tile');
  });
});

var rack = Array.from(document.querySelectorAll('.player1-tile'));
var board = Array.from(document.querySelectorAll('.board .tile'));
var dragdropArea = rack.concat(board);
(0, _dragula2.default)(dragdropArea);
// dragula([document.querySelector('.player1-rack'), Array.from(document.querySelectorAll('.row'))])

function dealTile() {
  var piece = (0, _lodash2.default)(inventory);
  inventory.splice(inventory.indexOf(piece), 1);
  return piece;
}

},{"./lib/player-racks.js":1,"./lib/scrabble-board.js":2,"./lib/scrabble-letters.js":3,"dragula":12,"lodash.sample":22}],5:[function(require,module,exports){
...
},{"ticky":24}],7:[function(require,module,exports){
'use strict';
...
},{"./debounce":6,"atoa":5}],8:[function(require,module,exports){
(function (global){
'use strict';
...
},{"./classes":11,"contra/emitter":7,"crossvent":8}],13:[function(require,module,exports){
/**
...
},{"lodash._basevalues":15,"lodash.keys":21}],19:[function(require,module,exports){
/**
 * lodash 3.0.4 (Custom Build) <https://lodash.com/>
 * Build: `lodash modern modularize exports="npm" -o ./`
 * Copyright 2012-2015 The Dojo Foundation <http://dojofoundation.org/>
...
},{"lodash._getnative":16,"lodash.isarguments":19,"lodash.isarray":20}],22:[function(require,module,exports){
/**
...
},{"lodash._baserandom":14,"lodash._isiterateecall":17,"lodash._toiterable":18,"lodash.toarray":23}],23:[function(require,module,exports){
/**
...
},{"lodash._arraycopy":13,"lodash._basevalues":15,"lodash.keys":21}],24:[function(require,module,exports){
